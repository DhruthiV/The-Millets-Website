...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <img src="images\logo-only.png" alt="" style="width: 15rem;">
   ...
   <br><br>
      ...
      <input type="number" name="number" min="0" max="9999999999" placeholder="Mobile Number" required onkeypress="if(this.value.length == 10) return false;" class="box">
